...
class Derleiti_Admin_Settings {
    ...
    public function render_performance_settings_page() {
        ...
        <!-- Inline Script für Cache-Leeren (optional – alternativ in eine separate JS-Datei auslagern) -->
        <script>
    ...
    public function sanitize_main_settings($input) {
        // Hier können die Haupteinstellungen validiert und bereinigt werden
        return $input;
    }
    ...
    public function sanitize_design_settings($input) {
        // Hier können die Design-Einstellungen validiert und bereinigt werden
        return $input;
    }
    ...
    public function sanitize_menu_settings($input) {
        // Hier können die Menü-Einstellungen validiert und bereinigt werden
        return $input;
    }
    ...
    public function sanitize_performance_settings($input) {
        // Hier können die Performance-Einstellungen validiert und bereinigt werden
        return $input;
    }
    ...
    public function sanitize_wordpress_settings($input) {
        // Hier können die WordPress-Einstellungen validiert und bereinigt werden
        return $input;
    }
    ...
    public function update_menu_settings() {
        ...
        if (!current_user_can('manage_options')) {
            wp_send_json_error(['message' => __('Keine Berechtigung.', 'derleiti-plugin')]);
        }

        // Get and sanitize data
        $menu_options = isset($_POST['menu_options']) ? $_POST['menu_options'] : [];

        // Sanitize and save options
        update_option('derleiti_menu_options', $menu_options);

        wp_send_json_success(['message' => __('Menü-Einstellungen gespeichert!', 'derleiti-plugin')]);
    }
    ...
    public function reset_settings() {
        ...
        switch ($settings_type) {
            ...
            case 'all':
                ...
                break;
            default:
                wp_send_json_error(['message' => __('Ungültiger Einstellungstyp.', 'derleiti-plugin')]);
                break;
        }

        wp_send_json_success(['message' => __('Einstellungen wurden zurückgesetzt!', 'derleiti-plugin')]);
    }
}

// Instantiate and initialize the settings
