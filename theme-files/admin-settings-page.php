...
class Derleiti_Admin_Settings {
    ...
    public function logo_upload_callback() {
        ...
        <div class="derleiti-logo-upload">
            ...
            <button type="button" class="button derleiti-upload-logo">Logo auswählen</button>
            <?php if (!empty($logo)): ?>
                <img src="<?php echo esc_url($logo); ?>" alt="Site Logo" style="max-width: 200px; margin-top: 10px;" />
                <button type="button" class="button derleiti-remove-logo">Logo entfernen</button>
            <?php endif; ?>
        </div>
        <?php
    }
    ...
    public function ajax_upload_logo() {
        ...
        wp_send_json_success([
            'url' => $upload['url'],
            'type' => $_POST['type'] // 'logo', 'favicon', etc.
        ]);
    }
    ...
    public function init() {
        ...
        // AJAX handlers for logo uploads
