...
class Derleiti_Blocks {
    ...
    public function enqueue_editor_assets() {
        // Editor-spezifisches Stylesheet
        wp_enqueue_style(
        ...
        // Lokalisiere Skript mit Übersetzungen und Asset-URLs
        wp_localize_script(
            'derleiti-blocks-editor',
            'derleitiBlocksData',
            array(
    ...
    public function render_testimonial_block($attributes, $content) {
        ...
        $html .= '</div>'; // .derleiti-testimonial-info
        
        $html .= '</div>'; // .derleiti-testimonial-footer
        $html .= '</div>'; // .derleiti-testimonial-content
        $html .= '</div>'; // .derleiti-testimonial
